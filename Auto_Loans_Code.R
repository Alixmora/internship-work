...
pacman::p_load(dplyr, forcats, janitor, lubridate, mosaic, purrr,
               tidyverse, ggplot2, ggpubr, lubridate, broom, caret)
...
################  Mathematical Model 1    
    ...
    # will be reused later with model 2 to create final dataset
    
   
################SAVING Validation and Training data    
...
write.csv(AUTOLOANS, "C:\\Users\\AlixMorales\\OneDrive - Flock Specialty Finance\\Documents\\Desktop\\AUTOLOANS_saved.csv" )
 ...
 ############ Cleaning Variables
  ...
  ## Eliminating Outliers (creates vehicles)
    ...
    ##### Additional Cleaning #####
        # Run average_prices again after #
  ...
  ##### saving as csv
    write.csv(kaggle_vehicles_unique, "C:\\Users\\AlixMorales\\OneDrive - Flock Specialty Finance\\Documents\\Desktop\\vehiclesconda.csv" )
    write.csv(vehicles, "C:\\Users\\AlixMorales\\OneDrive - Flock Specialty Finance\\Documents\\Desktop\\vehicles.csv" )
    
    
#################### joining Reliability Score
    ...
    # Data was joined in excel using vlookup
...
########### Spearman's Testing     
      ...
      #### The bottom code will only focus on the new variables, 
...
############### Creating the matrix to test distribution ###############
      ...
      matrix <- dcast(average_matrix, model1_predictions_deciles ~ model2_predictions_deciles, value.var = "average_prediction")
